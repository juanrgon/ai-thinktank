...
export const THINKTANK_LAB_DEFINITIONS: ThinktankLabDefinition[] = [
	...
	},
	{
		...
		preferredModelIds: [defaultModelPerProvider.anthropic, "claude-opus-4-7", "claude-opus-4.7"],
		displayModelIds: [defaultModelPerProvider.anthropic, "claude-opus-4-7", "claude-opus-4.7"],
